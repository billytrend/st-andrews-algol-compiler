export var grammar = {
    ...
    "<T5-clause>": "if<bool-clause>then<T5-clause>else<T5-clause>| case<T4-clause>of[<T4-clause>{,<T4-clause>}*:<T5-clause>;]*default:<T5-clause>| <T4-expression>",
    ...
    "<vecT4-exp7>": "@<int-clause>of<T4-type1><bra><T4-clause.list><ket> | vector<bounds>of<T4-clause>",
    "<bounds>": "<int-clause>::<int-clause>{,<bounds>}",
    "<T4-assign>": "<T4-identifier>|<T4-vec.exp>|<T4-struct.exp>",
    "<T4-vec.exp>": "<vecT4-expression>[(<int-clause.list>)]*",
    ...
    "<int-standard.name>": "[lwb|upb](<vecT4-clause>) | [readi|read.byte]{(<file-clause>)}",
    "<bool-standard.name>": "[eof|readb]{(<file-clause>)}",
    "<string-standard.name>": "[read|peek|reads|read.name|read.a.line]{(<file-clause>)}",
    ...
    "<T4-type1>": "{c}<T4-type>",
    "<T4-type>": "int|real|bool|string|pntr|file|<vecT4-type>",
    "<vecT4-type>": "<star><T4-type1>",
    "<arrow>": "'->'",
    "<cur>": "'{'",
    "<ly>": "'}'",
    "<bra>": "'['",
