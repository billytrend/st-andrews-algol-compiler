export var grammar = {
    ...
    "<*T4-exp7>": "@<int—clause>of<T4-type1><bra><T4-clause.list><ket> | vector<bounds>of<T4-clause>",
    "<bounds>": "<int—clause>::<int—clause>{,<bounds>}",
    "<T4—assign>": "<T4-identifier>|<T4—vec.exp>|<T4-struct.exp>",
    "<T4-vec.exp>": "<*T4—expression>[(<int—clause.list>)]*",
    ...
    "<int—standard.name>": "[lwb|upb](<*T4-clause>) | [readi|read.byte]{(<file-clause>)}",
    ...
    "<T4-type1>": "{c}<T4-type>",
    "<T4-type>": "int|real|boo||string|pntr|file|<*T4-type>",
    "<*T4-type>": "<star><T4-type1>",
    "<arrow>": "—>",
    "<cur>": "{",
    "<ly>": "}",
    "<bra>": "[",
